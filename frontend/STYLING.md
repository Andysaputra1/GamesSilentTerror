...
Di **game/game.css**, bagian GAME LAYOUT menyediakan --chat-width,
--hud-padding, dan --action-padding untuk mengatur game secara khusus.
Aturan breakpoint 850px menempatkan chat di bawah arena. Pada Main, 900px
