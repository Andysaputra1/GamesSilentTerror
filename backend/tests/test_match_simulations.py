        ...
        for count in range(4, 11):
            for limit in (6, 8, 12):
                for seed in range(10):
                    with self.subTest(players=count, limit=limit, seed=seed):
                        ...
                        for _ in range(limit * 3):
                            ...
                            for name, player in game.players.items():
                                ...
                                if not player.alive:
                                    self.assertFalse(
                                        me["can_chat"] or me["can_act"] or me["can_vote"]
                                    )
                                if player.hostage:
                        ...
                        self.assertLessEqual(game.round, limit)
                        ...
                        if game.winner == "civilians":
                            ...
                            self.assertEqual(game.round, limit)
                            self.assertTrue(hitman.alive)
                            self.assertGreater(free_citizens, 1)
